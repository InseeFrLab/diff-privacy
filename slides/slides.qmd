...
![](images/composition_avancee_gauss.png){fig-align="center"}
...
- Fixer un seuil (max du jeu de données) peut révèler… le max !
  → La sensibilité n'est pas protégé par la DP et peut être inféré à partir de quelques requêtes (en théorie ...)
