...
Nous voulons protéger un jeu de données $D$ tout en récupérant une sortie $S$ produite à partir de $D$.
...
La pure DP est assez restrictive, d'où des relaxations ont émergé dans la littérature.
...
Mécanisme vérifiant l'$(\varepsilon, \delta)$-DP ? Le bruit Gaussien :D
...
La formule imposte notamment que la Privacy Loss soit subgaussien.
...
## Le cas des comptages : un ca simple ? Pas vraiment ...
...
- Impose de suivre les différentes manières d'estimer un comptage si l'on ne veut pas fournir des estimations trop précises que voulut.
