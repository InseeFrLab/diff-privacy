...
$$
\frac{1}{\sigma^2_{\text{estimation, Total}}} = \frac{1}{m_{\text{Sexe}} \sigma^2_{\text{estimation, Sexe}}} + \frac{1}{m_{\text{Emploi}} \sigma^2_{\text{requête, Emploi}}} + \frac{1}{\sigma^2_{\text{requête}, Total}} 
$$
