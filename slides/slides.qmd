...
- **Mécanisme** : algorithme appliqué sur $D$ qui renvoie un résultat aléatoire. La propriété DP est associée à l'algorithme
...
Un mécanisme $M$ est dit $\varepsilon$-DP si pour tout $D \sim D'$ et toute ensemble de sortie $S$ :
...
$$
→ Variable aléatoire dont l'aléatoire provient de $M(D)$
